...
import { useResourcesByCompany } from "@/hooks/useResources";
...
export default function CompanyKnowledgeBasePage() {
  ...
  const { data: resources } = useResourcesByCompany(companyId, {}, !!companyId);
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl flex flex-col lg:flex-row">
        <main className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:py-12 max-w-6xl">
          <div
            ref={contentRef}
